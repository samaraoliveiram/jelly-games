defmodule JellyWeb.GameLive do
  ...
  def game_stage(%{current_phase: :word_selection} = assigns) do
    ...
    <div class="vertical-center">
      ...
      >
        ...
        <.form class="form" for={@form} phx-submit="send_words">
          <.input
            field={@form[:word_1]}
            pattern="[A-Za-z]*"
            required
  ...
  def handle_event("start", _params, socket) do
    ...
    case GameServer.start(socket.assigns.game_code, players) do
  ...
  def handle_event("send_words", params, socket) do
    {:ok, summary} =
      GameServer.send_words(
